...
const app = express();
const PORT = process.env.PORT || 5000; // Keep this as a default
...
// ✅ Test route (ensure this is present)
app.get("/test-route", (req, res) => {
    res.send("Test route is working!");
});

// ✅ Start server
app.listen(process.env.PORT || 5000, () => { // Explicitly use process.env.PORT
